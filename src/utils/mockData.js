...
export const mockBankTransactions = [
  ...
  },
  {
    id: 'TXN-ABN-9006',
    date: '2026-08-05',
    description: 'GS1 Nederland - Barcode Licentie & EAN Registratie',
    debit: 110,
    credit: 0,
    numericAmount: 110,
    amountStr: '€ 110,00',
    counterIban: 'NL77 ABNA 0222 3334 44',
    counterName: 'GS1 Nederland',
    remi: 'Factuur GS1-2026-891',
    eref: 'EREF-2026-9006',
    type: 'Transfer',
    category: 'bol.com sales costs / barcodes',
    status: 'Recognized',
    reviewReason: null,
    isInternal: false
  },
  ...
  },
  {
    id: 'TXN-ABN-9009',
    date: '2026-08-02',
    description: 'Int Card Services (ICS) - Maandelijkse Credit Card Verzamelnota',
    debit: 620,
    credit: 0,
    numericAmount: 620,
    amountStr: '€ 620,00',
    counterIban: 'NL33 ICSC 0400 1122 33',
    counterName: 'Int Card Services (ICS)',
    remi: 'ICS Credit Card Verzamelnota Aug 2026',
    eref: 'EREF-2026-9009',
    type: 'Direct debit',
  ...
  },
  {
    id: 'TXN-ABN-9010',
    date: '2026-08-01',
    description: 'Md. Joni Hossain - Buitenlandse Toeleverancier Inkoop',
    debit: 1400,
    credit: 0,
    numericAmount: 1400,
    amountStr: '€ 1.400,00',
    counterIban: 'BD88 SWIF 0900 1122 33',
    counterName: 'Md. Joni Hossain',
    remi: 'Buitenlandse Overboeking Supplier Inv 44',
    eref: 'EREF-2026-9010',
    type: 'Transfer',
    category: 'Purchasing',
    status: 'Recognized',
  ...
  },
  {
    id: 'TXN-ABN-9011',
    date: '2026-08-01',
    description: 'ABN AMRO Bank - Correspondent Bank Fee Buitenlandse Transactie Joni Hossain',
    debit: 25,
    credit: 0,
    numericAmount: 25,
    amountStr: '€ 25,00',
    counterIban: 'NL91 ABNA 0000 0000 00',
    counterName: 'ABN AMRO Bank N.V.',
    remi: 'Buitenlandse Bankkosten Correspondent Fee',
    eref: 'EREF-2026-9011',
    type: 'Transfer',
  ...
  },
  {
    id: 'TXN-ABN-9012',
    date: '2026-07-31',
    description: 'Beef.Steak / Luxury Meat B.V. - Relatiegeschenken Zomerpakket',
    debit: 185,
    credit: 0,
    numericAmount: 185,
    amountStr: '€ 185,00',
    counterIban: 'NL44 RABO 0333 4445 55',
    counterName: 'Beef.Steak / Luxury Meat B.V.',
    remi: 'Relatiegeschenken VIP Klanten',
    eref: 'EREF-2026-9012',
  ...
  },
  {
    ...
    reviewReason: 'Onbekende tegenpartij "Global Trading Direct Ltd" zonder herkenbaar factuurnummer of kenmerk.',
    isInternal: false
  }
];
