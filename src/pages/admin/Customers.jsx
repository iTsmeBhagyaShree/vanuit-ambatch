      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-dark/60 text-xs sm:text-sm mt-1">
            {language === 'EN' 
              ? 'Directory of approved lead clients automatically converted into active customer accounts.' 
              : 'Overzicht van goedgekeurde leads die automatisch zijn omgezet naar actieve klanten.'}
          </p>
        </div>
      </div>
