...
export default function CustomerDocuments() {
  ...
  const handleDownloadPDF = (title, name, isBlueprint = false) => {
    showToast(language === 'EN' ? `Generating PDF Document for "${name}"...` : `PDF Document genereren voor "${name}"...`);

    // Open a formatted print-ready HTML window that renders full AutoCAD Blueprint/Document layout and triggers PDF Save
    ...
    const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          .footer { margin-top: 50px; border-top: 1px solid #e2e8f0; pt-20px; text-align: center; font-size: 11px; color: #a0aec0; }
      ...
      <body>
        <div class="header">
          <div>
            ...
            <div class="subtitle">Official Project Documentation • Spec & Verification</div>
          </div>
        ...
        ${isBlueprint ? `
          <div class="cad-box">
            ...
            <p><strong>Document Ref:</strong> ${name}</p>
            <p><strong>Project:</strong> Luxury Outdoor Kitchen Amsterdam (#P-2001)</p>
            <p><strong>Scale:</strong> 1:20 • Approved Architectural Spec</p>
            ...
            <p style="font-size: 11px; color: #a5f3fc;">Verified by Head Craftsmen Tim & Bram • Certified Workshop Production Blueprint</p>
          </div>
        ` : `
          <div class="doc-card">
            <h2 style="color: #3E4E36; margin-top: 0;">${title}</h2>
            <p><strong>File Name:</strong> ${name}</p>
            <p><strong>Date Issued:</strong> ${new Date().toLocaleDateString()}</p>
            <hr style="border: none; border-top: 1px solid #edf2f7; margin: 20px 0;">
            <p style="line-height: 1.6; color: #4a5568;">
              This is an official verified document provided by <strong>Vanuit Ambacht B.V.</strong> 
              All terms, specifications, and warranty coverage detailed herein are active and binding for Project #P-2001.
            </p>
        ...
        <div class="footer">
          ...
          <br>
          Generated for Customer Portal • Document ID: ${name}
        </div>
