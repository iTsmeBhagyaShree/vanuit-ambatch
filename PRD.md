...
- **Leads Management**: Filterable table of incoming client inquiries, status tags (`New`, `Contacted`, `Quote Sent`, `Won`, `Lost`), quick action to convert lead into a formal quote.
